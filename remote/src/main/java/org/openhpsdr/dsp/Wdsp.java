  ...
  static {
    ...
    if(System.getProperty("os.name").startsWith("Windows")) {
      ...
      if (System.getProperty("os.arch") != null && System.getProperty("os.arch").endsWith("64")) {
        URL resource = Wdsp.class.getClassLoader().getResource("windows" + File.separator + "fftw_x64");
        libraryPath = resource.getPath();
      } else {
        URL resource = Wdsp.class.getClassLoader().getResource("windows" + File.separator + "fftw_x86");
        libraryPath = resource.getPath();
      }
    ...
    if(System.getProperty("os.name").startsWith("Mac")) {
      URL resource = Wdsp.class.getClassLoader().getResource("mac");
      String libraryPath = resource.getPath();
